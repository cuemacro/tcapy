...
if [ $TCAPY_PYTHON_ENV_TYPE == "virtualenv" ]; then
    ...
    pip install
        ...
        IPython==7.14.0 chartpy==0.1.8 findatapy==0.1.14 dash-auth==1.3.2 cufflinks==0.17.3 plotly==4.9.0 chart-studio==1.1.0 \
    ...
    pip install mysql-connector-python==8.0.19 chartpy==0.1.8 findatapy==0.1.16 dash-auth==1.3.2 cufflinks==0.17.3 plotly==4.9.0 \
        ...
        qpython==2.0.0 influxdb==5.2.3 \
        Flask-Session==0.3.1 \
        celery==4.4.7 pytest-tap kombu==4.6.7 python-memcached==1.59 WeasyPrint==51 pystore==0.1.15 fsspec==0.3.3 eikon==1.1.2
fi