...
if %TCAPY_PYTHON_ENV_TYPE%==virtualenv (
    ...
    call pip install ^
        ...
        chartpy==0.1.5 findatapy==0.1.9 IPython==7.13.0 dash-auth==1.3.2 cufflinks==0.17 plotly_express==0.4.1 dash-auth==1.3.2 ^
...
if %TCAPY_PYTHON_ENV_TYPE%==conda (
    ...
    call pip install mysql-connector-python==8.0.19 chartpy==0.1.5 findatapy==0.1.9 cufflinks==0.17 plotly_express==0.4.1 dash-auth==1.3.2 ^
      dash==1.8.0 dash-html-components==1.0.2 dash-core-components==1.7.0 plotly==4.5.0 dash-table==4.6.0 dtale==1.8.1 ^
      qpython==2.0.0 influxdb==5.2.2 ^
      Flask-Session==0.3.1 ^
