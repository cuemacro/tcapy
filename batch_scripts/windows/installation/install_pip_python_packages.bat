...
if %TCAPY_PYTHON_ENV_TYPE%==virtualenv (
    ...
    call pip install ^
        ...
        chartpy==0.1.5 findatapy==0.1.11 IPython==7.13.0 dash-auth==1.4.0 ^
...
if %TCAPY_PYTHON_ENV_TYPE%==conda (
    ...
    if %CONDA_FROM_YAML%==0 (
        ...
        call conda install -c conda-forge ^
            ...
            pyodbc=4.0.23 ^
            pytest=5.1.0 pytest-cov=2.5.1 ^
            numba=0.48.0 pyarrow=0.16.0 vispy=0.6.4 jinja2=2.11.1 xlwings=0.19.4 ^
        ...
        call pip install mysql-connector-python==8.0.19 chartpy==0.1.5 findatapy==0.1.11 dash-auth==1.3.2 cufflinks==0.17.3 plotly==4.8.0 ^
          dash==1.12.0 dash-html-components==1.0.3 dash-core-components==1.10.0 dash-table==4.7.0 jupyter-dash==0.2.1 dtale==1.8.1 ^
          qpython==2.0.0 influxdb==5.2.3 ^
          Flask-Session==0.3.1 ^
