...
sys.path.insert(0, tcapy_cuemacro)
# os.chdir(tcapy_cuemacro+ '/tcapypro/vis/')

from tcapypro.api.app_api import server as application
application.root_path = tcapy_cuemacro + '/tcapypro/api/'