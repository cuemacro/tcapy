...
from tcapy.data.databasesource import DatabaseSourceArctic, DatabaseSourcePyStore, DatabaseSourceInfluxDB, \
    DatabaseSourceKDB
...
class DataDumper(object):
    ...
    def upload_market_data_flat_file(self, data_vendor='dukascopy', market_data_store='arctic', host=None,
        ...
        if market_data_store == 'arctic':
            if host is None:
                ...
                database_source = DatabaseSourceArctic(postfix=data_vendor, host=host)
    ...
    def upload_trade_data_flat_file(self, sql_database_type=None, trade_data_database_name=None,
                                    ...
                                    server_host=None, if_exists_trade_table='replace'):
