...
logger.info("Database trade/order data source = " + constants.default_trade_data_store)
logger.info("Database market data source = " + constants.default_market_data_store)